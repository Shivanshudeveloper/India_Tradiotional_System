...
print 'It took ' + i + ' iterations to sort the deck.';</code></pre>
		...
		<!-- Scripts -->
			...
			<script>
				CKEDITOR.replace('problem1');
				CKEDITOR.replace('problem2');
				CKEDITOR.replace('problem3');
				CKEDITOR.replace('problem4');
				CKEDITOR.replace('problem5');
				CKEDITOR.replace('problem6');
				CKEDITOR.replace('problem7');
				CKEDITOR.replace('problem8');
				CKEDITOR.replace('problem9');
				CKEDITOR.replace('problem10');
				CKEDITOR.replace('problem11');
				CKEDITOR.replace('problem12');
				CKEDITOR.replace('problem13');
				CKEDITOR.replace('problem14');
				CKEDITOR.replace('problem15');
				CKEDITOR.replace('problem16');
				CKEDITOR.replace('problem17');
				CKEDITOR.replace('problem18');
				CKEDITOR.replace('problem19');
				CKEDITOR.replace('problem20');
			</script>
