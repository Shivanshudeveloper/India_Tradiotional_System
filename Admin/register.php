        ...
        <div class="container">
            ...
            <div class="row mt-2">
                ...
                <div class="col-sm-6 col-xl-4">
                    <div class="single_service_part">
                        <span class="single_service_icon">
                            <img class="w-25" src="https://cdn2.iconfinder.com/data/icons/bioinformatics-and-bioengineering-1/66/34-512.png" alt="" srcset="">
                        </span>
                        <h4>Researcher</h4>
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Researcher Registration</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                ...
                <div class="col-sm-6 col-xl-4">
                    <div class="single_service_part">
                        ...
                        <h4>Reviewer</h4>
                        <a href="#" data-toggle="modal" data-target="#exampleModal1" class="btn_3">Register <i class="ti-arrow-right"></i></a>
                    </div>
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Reviewer Registration</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <select class="form-control" name="category_sub1" id="category_sub1">
                            ...
                            <label class="mt-4" for="exampleInputEmail1">Upload Profile Pic</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="inputGroupFileAddon01">Upload</span>
                                </div>
